...
SELECT
    hash_key,
        ...
        TRY_CAST(CAST((UPPER(member_active_status)) AS VARCHAR) AS VARCHAR) AS active_status,
        TRY_CAST(CAST((UPPER(member_relationship_code)) AS VARCHAR) AS VARCHAR) AS relationship_code,
